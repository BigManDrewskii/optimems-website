...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      <Link
        href="/"
        className="absolute top-6 left-6 z-20 text-zinc-400 hover:text-[hsl(var(--primary))] transition-colors duration-200 flex items-center space-x-2"
      >
      ...
      <div className="absolute bottom-20 left-20 w-96 h-96 bg-[hsl(var(--primary))]/5 rounded-full blur-3xl" />
          ...
          <Link href="/" className="inline-block mb-6">
            <div className="flex items-center justify-center space-x-2">
              <svg
                ...
                aria-hidden="true"
                className="text-[hsl(var(--primary))] rounded-full size-8 w-8"
              >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-start gap-2">
              <label className="flex items-start gap-2 text-sm cursor-pointer">
                <input
                  type="checkbox"
                  className="mt-1 rounded border-zinc-700 bg-zinc-800 text-[hsl(var(--primary))] focus:ring-[hsl(var(--primary))]/20"
                  required
                />
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full bg-[hsl(var(--primary))] hover:bg-[hsl(var(--primary))]/90 text-white font-medium py-3 rounded-xl transition-colors"
              aria-live="polite"
              aria-busy={isLoading}
            >
